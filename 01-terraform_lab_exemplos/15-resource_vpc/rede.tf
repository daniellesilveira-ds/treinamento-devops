...
resource "aws_vpc" "main" {
  cidr_block       = "10.40.64.0/20" # uma classe de IP
...
resource "aws_internet_gateway" "gw" {
  ...
  tags = {
    Name = "aws_internet_gateway_terraform_dani"
  }
}
...
resource "aws_route_table" "rt_terraform" {
  ...
  tags = {
    Name = "route_table_terraform_dani"
  }
}
